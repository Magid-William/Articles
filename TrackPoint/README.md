...
- [6. Step 3: Using it](#6-step-3-using-it)
    - [6.1 My dev workflow](#61-my-dev-workflow)
- [7. Other Resources and Special Thanks](#7-other-resources-and-special-thanks)
...
## 5. Step 2: Choosing the approach
...
Wire either an [Arduino Pro Mini](#522-arduino-pro-mini) or an [ATtiny85](#523-attiny85) as the co-processor.
...
## 7. Other Resources and Special Thanks
